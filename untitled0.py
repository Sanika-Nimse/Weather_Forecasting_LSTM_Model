...
def map_weather_condition(condition_id):
    if 0 <= condition_id < 1:  # Thunderstorm
        ...
        return "Unknown"
def main():
    cities = ['Pune', 'Nashik', 'Mumbai']
    # For per hour predictions
    sequence_length = 10 # Adjust as needed
    future_days = 24  # Adjust as needed
    ...
    for city in cities:
        ...
        if weather_data:
            ...
            for day, pred in enumerate(predictions, 1):
                ...
                print(f"Per {day}.hr : Temperature: {pred[0]:.2f}°C, Humidity: {pred[1]:.2f}%, Rainfall: {pred[2]:.2f} mm, Weather Description: {weather_description}")
            print("=" * 50)
